...
call s:HL('GWStatusLineMode', 'coal', 'lime')
call s:HL('GWStatusLineModeX', 'lime', 'deepergravel')
...
call s:HL('fugitiveHeading', 'dress', 'bg', 'bold')
call s:HL('fugitiveHeader', 'dress', 'bg', 'bold')
call s:HL('fugitiveCount', 'plain', 'bg', 'bold')
call s:HL('fugitiveSymbolicRef', 'dirtyblonde', 'bg', 'none')
call s:HL('fugitiveModifier', 'dirtyblonde', 'bg', 'bold')
...
call s:HL('fishOperator',        'fg',    'bg', 'none')
call s:HL('fishDerefIdentifier', 'dress', 'bg', 'bold')
...
call s:HL('djangoTagBlock',  'coffee', 'bg', 'bold')
call s:HL('djangoStatement', 'orange', 'bg', 'none')
call s:HL('djangoArgument',  'dress', 'bg', 'none')
call s:HL('djangoVarBlock',  'lime', 'bg', 'none')

" }}}
" HTML/TEN {{{

call s:HL('tenTagBlock',  'orange', 'bg', 'bold')
call s:HL('tenArgument',  'lime', 'bg', 'none')
call s:HL('tenVarBlock',  'dress', 'bg', 'none')
...
call s:HL('jinjaVarBlock', 'dirtyblonde', '', 'bold')
call s:HL('jinjaVariable', 'dirtyblonde', '', 'bold')
call s:HL('jinjaTagBlock', 'toffee', '', 'bold')
call s:HL('jinjaStatement', 'toffee', '', 'bold')
call s:HL('jinjaOperator', 'snow', '', 'none')
call s:HL('jinjaFilter', 'dress', '', 'none')
call s:HL('jinjaString', 'coffee', '', 'bold')
...
call s:HL('texCmd', 'dress', '', 'none')
call s:HL('texCmdEnv', 'taffy', '', 'bold')
call s:HL('texCmdItem', 'dirtyblonde', '', 'none')
call s:HL('texPartArgTitle', 'plain', '', 'none')
call s:HL('texLstZone', 'toffee', '', 'none')

call s:HL('texMathZoneA', 'dirtyblonde', '', 'none')
call s:HL('texMathZoneB', 'dirtyblonde', '', 'none')
call s:HL('texMathZoneC', 'dirtyblonde', '', 'none')
call s:HL('texMathZoneD', 'dirtyblonde', '', 'none')
call s:HL('texMathZoneE', 'dirtyblonde', '', 'none')
call s:HL('texMathZoneV', 'dirtyblonde', '', 'none')
call s:HL('texMathZoneX', 'dirtyblonde', '', 'none')
...
call s:HL('scalaParameterAnnotation', 'gravel', '', 'bold')
call s:HL('scalaParamAnnotationValue', 'gravel', '', 'bold')
call s:HL('scalaCommentAnnotation', 'gravel', '', 'bold')
call s:HL('scalaDocLinks', 'gravel', '', 'bold')

" }}}
" Singularity {{{

call s:HL('singularitySectionLine', 'taffy', '', 'bold')
call s:HL('singularitySection', 'taffy', '', 'bold')
call s:HL('singularityKeyword', 'dress', '', '')
